...
class SchemaGenerator:
    ...
    def _infer_property_schema(
        ...
        if self.inference_mode == SchemaInferenceMode.STRICT:
            ...
            # Create validations list using new PropertyValidationSchema structure
            ...
            if isinstance(value, (int, float)):
                ...
                if isinstance(value, int) and not isinstance(value, bool):
                    validations.append(
                        {
                            "type": PropertyValidationType.MIN_VALUE,
                            "value": 0,
                    ...
                    validations.append(
                        {
                            "type": PropertyValidationType.MAX_VALUE,
                            "value": value * 2,
                ...
                validations.append(
                    {
                        "type": PropertyValidationType.MAX_LENGTH,
                        "value": max_len,
